...
(defun html-tt-load-hook ()
  ...
  (if (featurep 'hilit19)
      (hilit-add-pattern "\\[%" "%\\]" 'midnightblue 'html-mode)
    )

  ;; set font-lock
  (make-local-variable 'font-lock-defaults)
  (setq html-tt-font-lock-keywords
	(append html-font-lock-keywords html-tt-font-lock-keywords))
