...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (color-theme-modern wgrep zlc yasnippet undohist undo-tree quickrun magit open-junk-file paredit auto-complete color-moccur helm helm-descbinds expand-region el-get anything popwin bm google-translate company-lsp exec-path-from-shell shackle markdown-mode gnu-elpa-keyring-update tide graphql-mode flow-minor-mode ensime lua-mode gotest ruby-block rsense rfringe redo+ point-undo plenv mmm-mode migemo log4e lispxmp less-css-mode json-mode jedi jaunte init-loader htmlize highlight-symbol helm-perldoc helm-open-github helm-etags-plus helm-c-yasnippet helm-c-moccur helm-ack guide-key grep-a-lot goto-last-change go-eldoc gitignore-mode gitconfig-mode git-gutter-fringe gist free-keys foreign-regexp fold-dwim flymake-jslint elscreen eldoc-extension edit-server edit-list direx dash-at-point cperl-mode command-log-mode col-highlight coffee-mode codic auto-virtualenvwrapper auto-install auto-complete-c-headers auto-compile auto-async-byte-compile anzu anything-exuberant-ctags all-ext ack ac-octave ac-ispell))))
(custom-set-faces
